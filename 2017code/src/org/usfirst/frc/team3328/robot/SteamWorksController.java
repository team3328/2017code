...
public class SteamWorksController implements Controller {
	...
	public SteamWorksController(boolean type){
		if(type){
			joystick = true;
			joy = new Joystick(0);
		}else{
	...
	/* (non-Javadoc)
	 * @see org.usfirst.frc.team3328.robot.Controller#getX()
	 */
	@Override
	public double getX(){
		if (joystick){
	...
	/* (non-Javadoc)
	 * @see org.usfirst.frc.team3328.robot.Controller#getY()
	 */
	@Override
	public double getY(){
		if (joystick){
	...
	/* (non-Javadoc)
	 * @see org.usfirst.frc.team3328.robot.Controller#getButton(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.usfirst.frc.team3328.robot.Controller#getButtonPress(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.usfirst.frc.team3328.robot.Controller#getPad()
	 */
	@Override
